...
func GetJWT(jwt string, service int, module int, epic int, endpoint int) (int, bool, string, int) {
	...
	respuesta, _ := http.Get("http://147.182.242.142:5000/v1/trylogin?jwt=" + jwt + "&service=" + strconv.Itoa(service) + "&module=" + strconv.Itoa(module) + "&epic=" + strconv.Itoa(epic) + "&endpoint=" + strconv.Itoa(endpoint))
