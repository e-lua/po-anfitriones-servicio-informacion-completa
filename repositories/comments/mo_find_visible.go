...
func Mo_Find_Visible(idbusiness int, pagina int64) ([]*models.Mo_Comment_Comensal, error) {
	...
	var resultado []*models.Mo_Comment_Comensal
	...
	for cursor.Next(context.TODO()) {
		...
		var registro models.Mo_Comment_Comensal
